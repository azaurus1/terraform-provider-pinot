...
type TableSegmentsConfig struct {
	TimeType                  string `tfsdk:"time_type"`
	Replication               string `tfsdk:"replication"`
	TimeColumnName            string `tfsdk:"time_column_name"`
	SegmentAssignmentStrategy string `tfsdk:"segment_assignment_strategy"`
	SegmentPushType           string `tfsdk:"segment_push_type"`
	MinimizeDataMovement      bool   `tfsdk:"minimize_data_movement"`
}
...
type StarTreeIndexConfig struct {
	...
	SkipStarNodeCreationForDimensions []string `tfsdk:"skip_star_node_creation_for_dimensions"`
	FunctionColumnPairs               []string `tfsdk:"function_column_pairs"`
	MaxLeafRecords                    int      `tfsdk:"max_leaf_records"`
}
...
type TableIndexConfig struct {
	EnableDefaultStarTree                      bool                  `tfsdk:"enable_default_star_tree"`
	StarTreeIndexConfigs                       []StarTreeIndexConfig `tfsdk:"star_tree_index_configs"`
	TierOverwrites                             TierOverwrites        `tfsdk:"tier_overwrites"`
	EnableDynamicStarTreeCreation              bool                  `tfsdk:"enable_dynamic_star_tree_creation"`
	AggregateMetrics                           bool                  `tfsdk:"aggregate_metrics"`
	NullHandlingEnabled                        bool                  `tfsdk:"null_handling_enabled"`
	OptimizeDictionary                         bool                  `tfsdk:"optimize_dictionary"`
	OptimizeDictionaryForMetrics               bool                  `tfsdk:"optimize_dictionary_for_metrics"`
	NoDictionarySizeRatioThreshold             float64               `tfsdk:"no_dictionary_size_ratio_threshold"`
	RangeIndexVersion                          int                   `tfsdk:"range_index_version"`
	AutoGeneratedInvertedIndex                 bool                  `tfsdk:"auto_generated_inverted_index"`
	CreateInvertedIndexDuringSegmentGeneration bool                  `tfsdk:"create_inverted_index_during_segment_generation"`
	LoadMode                                   string                `tfsdk:"load_mode"`
	StreamConfigs                              map[string]string     `tfsdk:"stream_configs"`
}
...
type FieldConfig struct {
	...
	EncodingType    string          `tfsdk:"encoding_type"`
	IndexType       string          `tfsdk:"index_type"`
...
type TransformConfig struct {
	...
	TransformFunction string `tfsdk:"transform_function"`
}

type TableIngestionConfig struct {
	SegmentTimeValueCheckType string            `tfsdk:"segment_time_value_check_type"`
	TransformConfigs          []TransformConfig `tfsdk:"transform_configs"`
	ContinueOnError           bool              `tfsdk:"continue_on_error"`
	RowTimeValueCheck         bool              `tfsdk:"row_time_value_check"`
}

type TierConfig struct {
	Name                string `tfsdk:"name"`
	SegmentSelectorType string `tfsdk:"segment_selector_type"`
	SegmentAge          string `tfsdk:"segment_age"`
	StorageType         string `tfsdk:"storage_type"`
	ServerTag           string `tfsdk:"server_tag"`
}

type tablesModel struct {
	TableName        string               `tfsdk:"table_name"`
	TableType        string               `tfsdk:"table_type"`
	...
	IsDimTable       bool                 `tfsdk:"is_dim_table"`
}
